...
extern NSString *const QNAsyncUdpSocketException;
extern NSString *const QNAsyncUdpSocketErrorDomain;

extern NSString *const QNAsyncUdpSocketQueueName;
extern NSString *const QNAsyncUdpSocketThreadName;

typedef NS_ERROR_ENUM(QNAsyncUdpSocketErrorDomain, QNAsyncUdpSocketError) {
	QNAsyncUdpSocketNoError = 0,          // Never used
	QNAsyncUdpSocketBadConfigError,       // Invalid configuration
	QNAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	QNAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	QNAsyncUdpSocketClosedError,          // The socket was closed
	QNAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class QNAsyncUdpSocket;

@protocol QNAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(QNAsyncUdpSocket *)sock didReceiveData:(NSData *)data
 ...
 * Example:
 * 
 * QNAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^QNAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^QNAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface QNAsyncUdpSocket : NSObject

/**
 * QNAsyncUdpSocket uses the standard delegate paradigm,
...
- (instancetype)initWithDelegate:(nullable id<QNAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<QNAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq NS_DESIGNATED_INITIALIZER;

#pragma mark Configuration

- (nullable id<QNAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id<QNAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id<QNAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id<QNAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<QNAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<QNAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means QNAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, QNAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, QNAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, QNAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that QNAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about QNAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable QNAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable QNAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * QNAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, QNAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about QNAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable QNAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable QNAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The QNAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally QNAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
